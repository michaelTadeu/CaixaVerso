package com.example.shop.orders.adapters.inbound.rest;
...
public class OrdersController {
  ...
  public ResponseEntity<CreateOrderResponse> create(@Valid @RequestBody CreateOrderRequest req) {
    ...
    return ResponseEntity.status(201).body(new CreateOrderResponse(created.getId(), created.getStatus(), created.total()));
  }
  ...
  public record CreateOrderResponse(UUID id, OrderStatus status, java.math.BigDecimal total) {}
